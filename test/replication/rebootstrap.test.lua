...
test_run:cmd('restart server rebootstrap2 with cleanup=True, wait=False, wait_load=False, args="20 50"')
test_run:cmd('start server rebootstrap1 with args="20 50"')
